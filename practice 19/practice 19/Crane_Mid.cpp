...
Crane_Mid::Crane_Mid()
{
	...
	// Àü¸é »ö»ó
	data[0][1][0][0][0] = 0.0f, data[0][1][0][0][1] = 1.0f, data[0][1][0][0][2] = 0.0f;
	data[0][1][0][1][0] = 0.0f, data[0][1][0][1][1] = 1.0f, data[0][1][0][1][2] = 0.0f;
	data[0][1][0][2][0] = 0.0f, data[0][1][0][2][1] = 1.0f, data[0][1][0][2][2] = 0.0f;
						 							  
	data[0][1][1][0][0] = 0.0f, data[0][1][1][0][1] = 1.0f, data[0][1][1][0][2] = 0.0f;
	data[0][1][1][1][0] = 0.0f, data[0][1][1][1][1] = 1.0f, data[0][1][1][1][2] = 0.0f;
	data[0][1][1][2][0] = 0.0f, data[0][1][1][2][1] = 1.0f, data[0][1][1][2][2] = 0.0f;
	...
	// ÁÂÃø »ö»ó
	data[2][1][0][0][0] = 0.0f, data[2][1][0][0][1] = 1.0f, data[2][1][0][0][2] = 0.0f;
	data[2][1][0][1][0] = 0.0f, data[2][1][0][1][1] = 1.0f, data[2][1][0][1][2] = 0.0f;
	data[2][1][0][2][0] = 0.0f, data[2][1][0][2][1] = 1.0f, data[2][1][0][2][2] = 0.0f;
													 
	data[2][1][1][0][0] = 0.0f, data[2][1][1][0][1] = 1.0f, data[2][1][1][0][2] = 0.0f;
	data[2][1][1][1][0] = 0.0f, data[2][1][1][1][1] = 1.0f, data[2][1][1][1][2] = 0.0f;
	data[2][1][1][2][0] = 0.0f, data[2][1][1][2][1] = 1.0f, data[2][1][1][2][2] = 0.0f;
	...
	// ÈÄ¸é »ö»ó
	data[3][1][0][0][0] = 0.0f, data[3][1][0][0][1] = 1.0f, data[3][1][0][0][2] = 0.0f;
	data[3][1][0][1][0] = 0.0f, data[3][1][0][1][1] = 1.0f, data[3][1][0][1][2] = 0.0f;
	data[3][1][0][2][0] = 0.0f, data[3][1][0][2][1] = 1.0f, data[3][1][0][2][2] = 0.0f;
						  							  
	data[3][1][1][0][0] = 0.0f, data[3][1][1][0][1] = 1.0f, data[3][1][1][0][2] = 0.0f;
	data[3][1][1][1][0] = 0.0f, data[3][1][1][1][1] = 1.0f, data[3][1][1][1][2] = 0.0f;
	data[3][1][1][2][0] = 0.0f, data[3][1][1][2][1] = 1.0f, data[3][1][1][2][2] = 0.0f;
	...
	// ¿ìÃø »ö»ó
	data[5][1][0][0][0] = 0.0f, data[5][1][0][0][1] = 1.0f, data[5][1][0][0][2] = 0.0f;
	data[5][1][0][1][0] = 0.0f, data[5][1][0][1][1] = 1.0f, data[5][1][0][1][2] = 0.0f;
	data[5][1][0][2][0] = 0.0f, data[5][1][0][2][1] = 1.0f, data[5][1][0][2][2] = 0.0f;
						  							  
	data[5][1][1][0][0] = 0.0f, data[5][1][1][0][1] = 1.0f, data[5][1][1][0][2] = 0.0f;
	data[5][1][1][1][0] = 0.0f, data[5][1][1][1][1] = 1.0f, data[5][1][1][1][2] = 0.0f;
	data[5][1][1][2][0] = 0.0f, data[5][1][1][2][1] = 1.0f, data[5][1][1][2][2] = 0.0f;
}

void Crane_Mid::initBuffer()
{
