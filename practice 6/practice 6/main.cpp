...
struct Triangle {
	...
	Triangle(GLfloat mx, GLfloat my, GLfloat size) : x(mx), y(my), size(size) {
		...
		data[0][2][0] = mx,						  data[0][2][1] = my + (GLfloat)0.15 + size, data[0][2][2] = 0.0;
		for (int i = 0; i < 3; i++) {
			for (int j = 0; j < 3; j++) {
