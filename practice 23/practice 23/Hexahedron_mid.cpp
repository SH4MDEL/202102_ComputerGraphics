...
Hexahedron_mid::Hexahedron_mid()
{
	allReset();

	//GLfloat linear = 0.06f;	// 정육면체를 만들고 싶을 때 원하는 길이의 절반을 입력해줍니다.
	...
	GLfloat front_left_down_x = -0.08f, front_left_down_y = -0.1f, front_left_down_z = 0.08f;		// 직육면체를 만들고 싶을 때 적절히 수정해줍니다.
	GLfloat front_left_top_x = -0.08f, front_left_top_y = 0.1f, front_left_top_z = 0.08f;
	GLfloat front_right_down_x = 0.08f, front_right_down_y = -0.1f, front_right_down_z = 0.08f;
	GLfloat front_right_top_x = 0.08f, front_right_top_y = 0.1f, front_right_top_z = 0.08f;
	GLfloat back_left_down_x = -0.08f, back_left_down_y = -0.1f, back_left_down_z = -0.08f;
	GLfloat back_left_top_x = -0.08f, back_left_top_y = 0.1f, back_left_top_z = -0.08f;
	GLfloat back_right_down_x = 0.08f, back_right_down_y = -0.1f, back_right_down_z = -0.08f;
	GLfloat back_right_top_x = 0.08f, back_right_top_y = 0.1f, back_right_top_z = -0.08f;
...
void Hexahedron_mid::initBuffer()
{
...
void Hexahedron_mid::allReset()
{
	xPos = 0.0f, zPos = 0.0f;
	HeightFromGround = 0.2f;
}

void Hexahedron_mid::update()
{

}

void Hexahedron_mid::putFactor(glm::mat4 inputFactor)
{
	myFactor = inputFactor;
	myFactor = glm::translate(myFactor, glm::vec3(xPos, HeightFromGround, zPos));	// 기본으로 세팅할 객체의 위치
}

glm::mat4 Hexahedron_mid::getFactor()
{
	return myFactor;
}
