...
Hexahedron_top::Hexahedron_top()
{
	...
	GLfloat front_left_down_x = -0.06f, front_left_down_y = -0.1f, front_left_down_z = 0.06f;		// 직육면체를 만들고 싶을 때 적절히 수정해줍니다.
	GLfloat front_left_top_x = -0.06f, front_left_top_y = 0.1f, front_left_top_z = 0.06f;
	GLfloat front_right_down_x = 0.06f, front_right_down_y = -0.1f, front_right_down_z = 0.06f;
	GLfloat front_right_top_x = 0.06f, front_right_top_y = 0.1f, front_right_top_z = 0.06f;
	GLfloat back_left_down_x = -0.06f, back_left_down_y = -0.1f, back_left_down_z = -0.06f;
	GLfloat back_left_top_x = -0.06f, back_left_top_y = 0.1f, back_left_top_z = -0.06f;
	GLfloat back_right_down_x = 0.06f, back_right_down_y = -0.1f, back_right_down_z = -0.06f;
	GLfloat back_right_top_x = 0.06f, back_right_top_y = 0.1f, back_right_top_z = -0.06f;
...
void Hexahedron_top::initBuffer()
{
...
void Hexahedron_top::allReset()
{
	xPos = 0.0f, zPos = 0.0f;
	HeightFromGround = 0.2f;
}

void Hexahedron_top::update()
{

}

void Hexahedron_top::putFactor(glm::mat4 inputFactor)
{
	myFactor = inputFactor;
	myFactor = glm::translate(myFactor, glm::vec3(xPos, HeightFromGround, zPos));	// 기본으로 세팅할 객체의 위치
}

glm::mat4 Hexahedron_top::getFactor()
{
	return myFactor;
}
