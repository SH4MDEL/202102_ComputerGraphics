...
Robot_leftarm::Robot_leftarm()
{
	...
	GLfloat back_color_r = 0.0f, back_color_g = 1.0f, back_color_b = 0.0f;
...
void Robot_leftarm::putFactor(glm::mat4 inputFactor)
{
...
glm::mat4 Robot_leftarm::getFactor()
{
	return myFactor;
}
