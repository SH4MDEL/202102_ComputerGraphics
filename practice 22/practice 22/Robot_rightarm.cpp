...
Robot_rightarm::Robot_rightarm()
{
	...
	GLfloat back_color_r = 0.5f, back_color_g = 0.9f, back_color_b = 0.5f;
...
void Robot_rightarm::initBuffer()
{
...
void Robot_rightarm::putFactor(glm::mat4 inputFactor)
{
	myFactor = inputFactor;
	myFactor = glm::translate(myFactor, glm::vec3(0.25f, HeightFromGround, 0.0f));	// 기본으로 세팅할 객체의 위치
...
glm::mat4 Robot_rightarm::getFactor()
{
	return myFactor;
}