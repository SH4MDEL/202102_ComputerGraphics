...
Robot_head::Robot_head()
{
	...
	GLfloat front_left_down_x = -0.1f, front_left_down_y = -0.1f, front_left_down_z = 0.1f;		// 직육면체를 만들고 싶을 때 적절히 수정해줍니다.
	GLfloat front_left_top_x = -0.1f, front_left_top_y = 0.1f, front_left_top_z = 0.1f;
	GLfloat front_right_down_x = 0.1f, front_right_down_y = -0.1f, front_right_down_z = 0.1f;
	GLfloat front_right_top_x = 0.1f, front_right_top_y = 0.1f, front_right_top_z = 0.1f;
	GLfloat back_left_down_x = -0.1f, back_left_down_y = -0.1f, back_left_down_z = -0.1f;
	GLfloat back_left_top_x = -0.1f, back_left_top_y = 0.1f, back_left_top_z = -0.1f;
	GLfloat back_right_down_x = 0.1f, back_right_down_y = -0.1f, back_right_down_z = -0.1f;
	GLfloat back_right_top_x = 0.1f, back_right_top_y = 0.1f, back_right_top_z = -0.1f;
	...
	// 코 좌표
	data[6][0][0][0][0] = -0.02f, data[6][0][0][0][1] = -0.02f, data[6][0][0][0][2] = 0.11f;
	data[6][0][0][1][0] = 0.02f, data[6][0][0][1][1] = -0.02f, data[6][0][0][1][2] = 0.11f;
	data[6][0][0][2][0] = -0.02f, data[6][0][0][2][1] = 0.02f, data[6][0][0][2][2] = 0.11f;
		 
	data[6][0][1][0][0] = -0.02f, data[6][0][1][0][1] = -0.02f, data[6][0][1][0][2] = 0.11f;
	data[6][0][1][1][0] = 0.02f, data[6][0][1][1][1] = -0.02f, data[6][0][1][1][2] = 0.11f;
	data[6][0][1][2][0] = 0.02f, data[6][0][1][2][1] = 0.02f, data[6][0][1][2][2] = 0.11f;

	// 코 색상
	data[6][1][0][0][0] = 0.9f, data[6][1][0][0][1] = 0.9f, data[6][1][0][0][2] = 0.9f;
	data[6][1][0][1][0] = 0.9f, data[6][1][0][1][1] = 0.9f, data[6][1][0][1][2] = 0.9f;
	data[6][1][0][2][0] = 0.9f, data[6][1][0][2][1] = 0.9f, data[6][1][0][2][2] = 0.9f;

	data[6][1][1][0][0] = 0.9f, data[6][1][1][0][1] = 0.9f, data[6][1][1][0][2] = 0.9f;
	data[6][1][1][1][0] = 0.9f, data[6][1][1][1][1] = 0.9f, data[6][1][1][1][2] = 0.9f;
	data[6][1][1][2][0] = 0.9f, data[6][1][1][2][1] = 0.9f, data[6][1][1][2][2] = 0.9f;
}

void Robot_head::initBuffer()
{
...
void Robot_head::allReset()
{
	HeightFromGround = 0.3f;
}

void Robot_head::update()
{

}

void Robot_head::putFactor(glm::mat4 inputFactor)
{
	myFactor = inputFactor;
	myFactor = glm::translate(myFactor, glm::vec3(0.0f, HeightFromGround, 0.0f));	// 기본으로 세팅할 객체의 위치
}

glm::mat4 Robot_head::getFactor()
{
	return myFactor;
}