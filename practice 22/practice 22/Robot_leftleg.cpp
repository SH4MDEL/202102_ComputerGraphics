...
Robot_leftleg::Robot_leftleg()
{
	...
	GLfloat back_color_r = 0.8f, back_color_g = 0.8f, back_color_b = 0.3f;
...
void Robot_leftleg::putFactor(glm::mat4 inputFactor)
{
...
glm::mat4 Robot_leftleg::getFactor()
{
	return myFactor;
}