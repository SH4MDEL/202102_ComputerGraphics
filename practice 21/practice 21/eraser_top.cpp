...
eraser_top::eraser_top()
{
	...
	GLfloat front_left_down_x = -0.1f, front_left_down_y = -0.2f, front_left_down_z = 0.1f;		// 직육면체를 만들고 싶을 때 적절히 수정해줍니다.
	GLfloat front_left_top_x = -0.1f, front_left_top_y = 0.2f, front_left_top_z = 0.1f;
	GLfloat front_right_down_x = 0.1f, front_right_down_y = -0.2f, front_right_down_z = 0.1f;
	GLfloat front_right_top_x = 0.1f, front_right_top_y = 0.2f, front_right_top_z = 0.1f;
	GLfloat back_left_down_x = -0.1f, back_left_down_y = -0.2f, back_left_down_z = -0.1f;
	GLfloat back_left_top_x = -0.1f, back_left_top_y = 0.2f, back_left_top_z = -0.1f;
	GLfloat back_right_down_x = 0.1f, back_right_down_y = -0.2f, back_right_down_z = -0.1f;
	GLfloat back_right_top_x = 0.1f, back_right_top_y = 0.2f, back_right_top_z = -0.1f;

	GLfloat back_color_r = 0.0f, back_color_g = 0.0f, back_color_b = 1.0f;
	GLfloat front_color_r = 0.0f, front_color_g = 0.0f, front_color_b = 1.0f;
	GLfloat bottom_color_r = 0.0f, bottom_color_g = 0.0f, bottom_color_b = 1.0f;
	GLfloat up_color_r = 0.0f, up_color_g = 0.0f, up_color_b = 1.0f;
	GLfloat left_color_r = 0.0f, left_color_g = 0.0f, left_color_b = 1.0f;
	GLfloat right_color_r = 0.0f, right_color_g = 0.0f, right_color_b = 1.0f;
...
void eraser_top::allReset()
{
	xPos = 0.0f, zPos = 0.0f;
	HeightFromGround = 0.4f;
}

void eraser_top::update()
{

}

void eraser_top::putFactor(glm::mat4 inputFactor)
{
	myFactor = inputFactor;
	myFactor = glm::translate(myFactor, glm::vec3(xPos, HeightFromGround, zPos));	// 기본으로 세팅할 객체의 위치
}

glm::mat4 eraser_top::getFactor()
{
	return myFactor;
}
